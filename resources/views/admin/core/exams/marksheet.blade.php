...
<body>
            ...
            <div class="header">
                ...
                <div class="header-flex">
                    ...
                    <div class="logo-box">
                        ...
                        @if (!empty($schoolLogo))
                            <img src="{{ asset($schoolLogo) }}" alt="School Logo">
                        @endif
                    ...
                    <div class="school-center">
                        ...
                        <div class="school-details">
                            ...
                            <div>
                                ...
                                {{ optional($school->schoolDetailAffiliation)->meta_value ?? 'CBSE' }}
                        ...
                        <div class="school-details">
                            ...
                            <div>
                                ...
                                {{ optional($school->schoolDetailSlogan)->meta_value ?? 'Knowledge Is Power' }}
                    ...
                    <div class="right-side">
                        ...
                        <div class="student-photo">
                            ...
                            <img src="{{ asset(optional($student->userprofile)->avatar ?? 'uploads/default.png') }}"
                                alt="Student Photo">
    ...
    $fatherLink = DB::table('student_parent_links')
    ...
    if ($fatherLink) {
        ...
        $fatherProfile = DB::table('userprofiles')
            ->where('user_id', $fatherLink->parent_id)
            ->first();
...
{{ strtoupper($fatherName ?: '-') }}
    ...
    {{
        optional($student->userprofile)->dateofbirth

        ??

        optional($student->userprofile)->date_of_birth
        ...
        optional($student)->dob

        ??

        optional($student)->date_of_birth

                        ...
                        @forelse($fees as $fee)
                            <tr class="hover:bg-gray-50 transition">
                                <td class="px-5 py-3">
                                    ...
                                    <div class="text-[10px] text-gray-400 uppercase font-bold tracking-tighter">
                                        {{ $fee->billing_cycle ?? $fee->payment_period ?? 'Monthly' }}
                                    </div>
                                </td>
                                <td class="px-5 py-3">
                                    ...
                                    <div class="text-[10px] text-gray-400 font-mono mt-0.5 uppercase tracking-tighter">ID:
                                        {{ $fee->user_id }}
                                    </div>
                                </td>
                                ...
                                <td class="px-5 py-3 text-center">
                                    @if($fee->balance <= 0)
                                        <span
                                            class="inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-bold bg-green-100 text-green-700 uppercase tracking-wider">Paid</span>
                                    @elseif($fee->paid_amount > 0)
                                        <span
                                            class="inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-bold bg-yellow-100 text-yellow-700 uppercase tracking-wider">Partial</span>
                                    @else
                                        <span
                                            class="inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-bold bg-red-100 text-red-700 uppercase tracking-wider">Unpaid</span>
                                    @endif
                                </td>
                                <td class="px-5 py-3 text-center">

...
<div class="relative">
    ...
    <div class="flex flex-wrap lg:flex-row justify-between my-3">
        <div>
            <h1 class="admin-h1 my-3">Edit Fee Category</h1>
        </div>
    ...
    <form method="POST" action="{{ route('finance.fee-categories.update', $feeCategory->id) }}"
        ...
        <div class="p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                @include('admin.finance.fee-categories.form', ['category' => $feeCategory])
            </div>
        </div>
        ...
        <div class="bg-gray-50 border-t border-gray-100 p-6 flex items-center gap-4">
            <button type="submit" class="no-underline text-white px-8 flex items-center custom-green py-2 justify-center">
                <span class="text-[10px] font-bold uppercase tracking-wider">Update Category</span>
            </button>
